...
public class TestExportExcel {
	...
	public void testWrite03Excel() throws Exception {
		...
		//输出到硬盘
		FileOutputStream outputStream = new FileOutputStream("D:\\test\\测试.xls");
		//把excel输出到具体的地址
	...
	public void testWrite07Excel() throws Exception {
		...
		//输出到硬盘
		FileOutputStream outputStream = new FileOutputStream("D:\\test\\测试.xlsx");
		//把excel输出到具体的地址
		workbook.write(outputStream);
		workbook.close();
		outputStream.close();
	...
	public void testRead03Excel() throws Exception {
		FileInputStream inputStream = new FileInputStream("D:\\test\\测试.xls");
		//1、读取工作簿
	...
	public void testRead07Excel() throws Exception {
		FileInputStream inputStream = new FileInputStream("D:\\test\\测试.xlsx");
		//1、读取工作簿
